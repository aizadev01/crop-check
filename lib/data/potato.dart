...
List<Plant> potatoPlants = [
  Plant(
      ...
      treatment:
          TreatmentData(description: "A healthy potato plant exhibits lush, green foliage free of spots, discoloration, or damage. The plant is vigorous with strong stems and an extensive root system. Healthy potato plants produce high yields of well-formed, disease-free tubers. Proper care and maintenance are crucial to ensure the plant's health and productivity.",
              points: ["Location and Soil:Plant potatoes in a sunny spot with well-drained, fertile soil.
              Ensure the soil is slightly acidic to neutral (pH 5.0-7.0) for optimal growth.
  Use raised beds or hills to improve drainage and reduce the risk of disease.","Watering:

      Provide consistent moisture, especially during the tuber formation stage.
  Water at the base of the plant to avoid wetting the foliage, which can lead to fungal diseases.
  Use drip irrigation or soaker hoses to ensure deep watering and reduce water wastage.","Fertilization:

  Apply a balanced fertilizer or compost to supply essential nutrients.
  ...
  Mulch also adds nutrients to the soil as it decomposes and protects tubers from sunlight exposure, which can cause greening.
  ","Hilling:

  Regularly hill soil around the base of the plants to cover tubers and encourage deeper rooting.
  Hilling also helps prevent tuber greening and protects against pests.","Pest and Disease Management:

Monitor plants regularly for pests such as Colorado potato beetles, aphids, and wireworms.
Use integrated pest management (IPM) strategies, including biological controls, organic treatments, or appropriate pesticides.
Rotate crops to prevent soil-borne diseases and pests from building up in the soil.","Pruning and Debris Removal:

Remove any yellowing or damaged leaves to promote airflow and reduce the risk of disease.
Keep the garden clean by removing plant debris and weeds promptly.","Monitoring:

Regularly check for signs of nutrient deficiencies, such as yellowing or stunted growth.
Inspect plants for early signs of disease, such as blight or blackleg, and take prompt action if needed.
...
Plant potato varieties that are resistant or tolerant to early blight.
...
Avoid planting potatoes or related crops in the same field consecutively to reduce disease pressure.","Sanitation:

Keep the field clean and free of plant debris that could harbor the fungus.
Remove and destroy any infected plant material promptly to prevent spore dispersal.","Water Management:

Avoid overhead irrigation to reduce leaf wetness and the spread of fungal spores.
Water at the base of the plants and use drip irrigation or soaker hoses to keep foliage dry.","Fungicides:

Apply fungicides labeled for early blight control according to the manufacturer's instructions.
Begin fungicide applications preventatively, especially during periods of high humidity and warmth, and continue at regular intervals throughout the growing season.","Cultural Practices:

Ensure proper spacing between plants to improve airflow and reduce humidity levels.
Hill soil around the base of the plants to cover tubers and encourage deeper rooting, which can help reduce disease pressure.","Nutrient Management:

Maintain adequate nutrition to promote strong, healthy plants.
Avoid excessive nitrogen, which can promote lush foliage more susceptible to early blight.","Monitoring:

Regularly inspect potato plants for signs of early blight, particularly during warm, humid weather.
...
Plant potato varieties that are resistant or tolerant to late blight.
Using resistant varieties is one of the most effective strategies to manage the disease.","Crop Rotation:

Practice crop rotation with non-host crops to break the disease cycle.
Avoid planting potatoes or related crops in the same field consecutively to reduce disease pressure.","Sanitation:

Keep the field clean and free of plant debris that could harbor the pathogen.
Remove and destroy any infected plant material promptly to prevent spore dispersal.
Ensure proper disposal of cull piles and volunteer potatoes, which can be sources of infection.","Water Management:

Avoid overhead irrigation to reduce leaf wetness and the spread of spores.
...
Apply fungicides labeled for late blight control according to the manufacturer's instructions.
Begin fungicide applications preventatively, especially during periods of cool, wet weather, and continue at regular intervals throughout the growing season.
Rotate fungicides with different modes of action to prevent resistance development.","Cultural Practices:

Ensure proper spacing between plants to improve airflow and reduce humidity levels.
Hill soil around the base of the plants to cover tubers and prevent exposure to spores.
Mulch to prevent soil from splashing onto the leaves, which can introduce pathogens.
","Nutrient Management:

Maintain adequate nutrition to promote strong, healthy plants.
Avoid excessive nitrogen, which can promote lush foliage more susceptible to late blight.","Monitoring:

Regularly inspect potato plants for signs of late blight, especially during cool, wet weather.
Early detection allows for prompt intervention and better disease management.
